...
//int main() {
//	int err;
//	err = is_convex_polygon(4, 0, 0, 2, 0, 2, 2, 0, 2); // This polygon is really convex
//	//err = is_convex_polygon(5, 0, 0, 2, 0, 1, 1, 2, 2, 0, 2); // This polygon is really NOT convex
//	//err = is_convex_polygon(9,
//	//	-2, 0, 
//	//	0, 2, 
//	//	2, 0, 
//	//	-2, -4, 
...
//	//	6, 0,
//	//	2, -4,
//	//	-2, 0); // This polygon is really NOT convex
//
//	switch (err)
//	{
